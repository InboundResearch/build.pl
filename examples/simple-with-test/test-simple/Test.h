...
#define     TEST_ASSERTION(x) if (not (x)) { char* buffer = new char[256]; snprintf (buffer, 256, "ASSERTION FAILURE (FILE: %s, LINE: %d)", __FILE__, __LINE__); throw runtime_error (buffer); }
